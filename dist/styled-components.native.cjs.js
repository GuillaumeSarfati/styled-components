...
var StyleSheet = _interopDefault(require('react-native-extended-stylesheet'));
...
var excludeShorthands = ['borderRadius', 'borderWidth', 'borderColor', 'borderStyle'];
      ...
      if (!generated[hash]) {
        ...
        root.each(function (node) {
          if (node.type === 'decl') {
            ...
            mediaObject['@' + node.name + ' ' + node.params] = transformDeclPairs(node.nodes.map(function (innerNode) {
              return [innerNode.prop, innerNode.value];
            }), excludeShorthands);
        ...
        var styleObject = transformDeclPairs(declPairs, excludeShorthands);
        var styles = styleSheet.create({
          generated: _extends({}, styleObject, mediaObject)
        });
